...
Для использования пользовательского скрипта сборки выполните `pybuild custom.xml`
...
После этого команда `pybuild` (в Windows — `pybuild.exe`) будет доступна в последующих задачах
